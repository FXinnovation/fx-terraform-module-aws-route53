...
output "route53_zone_private_name_servers" {
  ...
  value       = "${module.default.zone_private_name_servers}"
}
...
output "route53_zone_association_private_vpc_region" {
  ...
  value       = "${module.default.zone_association_private_vpc_region}"
}
...
output "route53_rule_association_forward_id" {
  ...
  value       = "${module.default.rule_association_forward_id}"
}
...
output "route53_resource_association_forward_id" {
  ...
  value       = "${module.default.resource_association_forward_id}"
}

output "route53_principal_association_forward_id" {
  description = "The Amazon Resource Name (ARN) of the Resource Share and the principal, separated by a comma."
  value       = "${module.default.principal_association_forward_id}"
}
