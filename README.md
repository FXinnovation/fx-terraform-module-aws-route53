...
| rule\_forward\_attachement\_ids\_count | How many var.rule\_forward\_attachement\_ids. This value cannot be computed automatically in Terraform 0.11. | string | `"0"` | no |
